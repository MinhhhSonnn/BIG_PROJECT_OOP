...
public class ListUserController {
  ...
  public ObservableList<Reader> listReaderSearch() {
    ...
    try {
      ...
      while (resultSearch2.next()) {
        reader = new Reader(resultSearch2.getString("userName"),
            resultSearch2.getString("password"), resultSearch2.getString("email"),
            resultSearch2.getInt("numberBorrowedBooks"), resultSearch2.getInt("numberViolations"));
  ...
  public ObservableList<Reader> listUserDefault() {
    ...
    try {
      ...
      while (resultDefault.next()) {
        reader = new Reader(resultDefault.getString("userName"),
            resultDefault.getString("password"), resultDefault.getString("email"),
            resultDefault.getInt("numberBorrowedBooks"), resultDefault.getInt("numberViolations"));
  ...
  */
  ...
  public void showReader() {
    ...
    numberBorrowedBooksColumn.setCellValueFactory(
        new PropertyValueFactory<>("numberOfBooksBorrow"));
  ...
  public void selectReader() {
    ...
    try {
      ...
      FXMLLoader loader = new FXMLLoader(
          getClass().getResource("/org/example/btl/DetailUser.fxml"));
