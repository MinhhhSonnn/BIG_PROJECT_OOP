  ...
  public ObservableList<Book> listBookSearch() {
    ...
    try {
      ...
      while (resultSearch2.next()) {
        book = new Book(resultSearch2.getString("bookName"), resultSearch2.getString("author"),
            resultSearch2.getString("ISBN"), resultSearch2.getInt("quantity"),
            resultSearch2.getString("description"), resultSearch2.getString("imageUrl"),
            resultSearch2.getString("publicationYear"), resultSearch2.getString("category"));
  ...
  public ObservableList<Book> listBookDefault() {
    ...
    try {
      ...
      while (resultDefault.next()) {
        book = new Book(resultDefault.getString("bookName"), resultDefault.getString("author"),
            resultDefault.getString("ISBN"), resultDefault.getInt("quantity"),
            resultDefault.getString("description"), resultDefault.getString("imageUrl"),
            resultDefault.getString("publicationYear"), resultDefault.getString("category"));
  ...
  public void selectBook() {
    ...
    try {
      ...
      FXMLLoader loader = new FXMLLoader(
          getClass().getResource("/org/example/btl/DetailBookUser.fxml"));
  ...
  public void showTopBook() {
    ...
    try {
      ...
      while (resultTopBook.next()) {
        ...
        Book book = new Book(resultFindTopBook.getString("bookName"),
            resultFindTopBook.getString("author"), resultFindTopBook.getString("ISBN"),
            resultFindTopBook.getInt("quantity"),
            resultFindTopBook.getString("description"), resultFindTopBook.getString("imageUrl"),
            resultFindTopBook.getString("publicationYear"),
            resultFindTopBook.getString("category"));
