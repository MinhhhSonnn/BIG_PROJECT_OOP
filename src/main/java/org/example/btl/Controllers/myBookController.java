...
public class myBookController {
  ...
  public void selectRecord(){
    ...
    try {
      ...
      FXMLLoader loader = new FXMLLoader(getClass().getResource("/org/example/btl/detailReturnBook.fxml"));
      ...
      try {
        ...
        resultFind.next();
        book = new Book(resultFind.getString("bookName"), resultFind.getString("author"), resultFind.getString("ISBN"), resultFind.getInt("quantity"),
            resultFind.getString("description"), resultFind.getString("imageUrl"), resultFind.getString("publicationYear"), resultFind.getString("category"));
      } catch (Exception e) {
        e.printStackTrace();
      }
