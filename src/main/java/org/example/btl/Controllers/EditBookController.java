...
public class EditBookController {
  ...
  public void addBook() {
    ...
    if (ISBNTextField.getText().isEmpty() || quantityTextField.getText().isEmpty()) {
      ...
      alert.showAndWait();
        ...
        || Integer.parseInt(quantityTextField.getText()) > 2147483640
      ...
      try {
        ...
        if (result.next()) {
          ...
          prepareAddQR.setString(2,
              "D:\\subject\\oop\\BTL\\QrCodePNG\\" + ISBNTextField.getText() + ".png");
  ...
  public void updateBook() {
    Alert alert;
    if (!isInteger(quantityNewTextField.getText())
        || Integer.parseInt(quantityNewTextField.getText()) > 2147483640
        || Integer.parseInt(quantityNewTextField.getText()) < 0) {
    ...
    try {
      ...
      if (ISBNNewTextField.getText().isEmpty()) {
        ...
        try {
          ...
          Book book = new Book(resultChange.getString("bookName"), resultChange.getString("author"),
              resultChange.getString("ISBN"), resultChange.getInt("quantity"),
              resultChange.getString("description"), resultChange.getString("imageUrl"),
              resultChange.getString("publicationYear"), resultChange.getString("category"));
  ...
  public void deleteBook() {
    ...
    try {
      ...
      if (ISBNOldTextField.getText().isEmpty()) {
        ...
        File file = new File(
            "D:\\subject\\oop\\BTL\\QrCodePNG\\" + ISBNOldTextField.getText() + ".png");
        file.delete();
