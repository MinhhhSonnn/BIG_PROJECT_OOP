...
public class EmailUntil {
  ...
  // Mật khẩu ứng dụng (App Password) từ Google Account
  ...
  public static void sendPasswordResetEmail(String recipientEmail, String newPassword) {
    ...
    try {
      ...
      message.setSubject("Khôi phục mật khẩu - Hệ thống Quản lý Thư viện");

      // Nội dung email
      String emailContent = String.format(
          "Xin chào,\n\n" +
              "Đây là email khôi phục mật khẩu của bạn từ Hệ thống Quản lý Thư viện.\n" +
