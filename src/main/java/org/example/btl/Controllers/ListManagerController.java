  ...
  public ObservableList<Manager> listEmployeeSearch() {
    ...
    try {
      ...
      while (resultSearch2.next()) {
        employee = new Manager(resultSearch2.getInt("ID"), resultSearch2.getString("employeeName"),
            resultSearch2.getString("sex"), resultSearch2.getString("position"),
            resultSearch2.getString("phone"), resultSearch2.getString("email"));
  ...
  public ObservableList<Manager> listEmployeeDefault() {
    ...
    try {
      ...
      while (resultDefault.next()) {
        employee = new Manager(resultDefault.getInt("ID"), resultDefault.getString("employeeName"),
            resultDefault.getString("sex"), resultDefault.getString("position"),
            resultDefault.getString("phone"), resultDefault.getString("email"));
