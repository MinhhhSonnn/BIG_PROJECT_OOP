...
public class changeManagerController {
  ...
  public void addEmployee(){
    Alert alert;
    if (employeeNameAddTextField.getText().isEmpty() || sexAddTextField.getText().isEmpty() || positionAddTextField.getText().isEmpty() || phoneAddTextField.getText().isEmpty() || emailAddTextField.getText().isEmpty()){
